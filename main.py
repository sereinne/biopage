...
# class Intro(Scene):
#     def construct(self):
#         hi = Text("Hello, There!").scale(2.75)
#         hi.set_fill(opacity=0)
#         hi.set_stroke(color=WHITE, width=1.5)
#         name = Text("I'm Muhammad Akbar Ilman Setijadi")
#         pfp = SVGMobject("./assets/github_pfp.svg")
#
#         blue_gradient = color_gradient(BLUE_GRADIENT, len(name))
#         name.set_color_by_gradient(blue_gradient)
#
#         grouped_texts = Group(pfp, hi, name)
#         grouped_texts.arrange(DOWN, buff=1.25)
#
#         self.play(
#             DrawBorderThenFill(pfp),
#             AddTextLetterByLetter(name),
#             DrawBorderThenFill(hi),
#             run_time=1.5,
#         )
#
#         self.play(
#             LaggedStart(Unwrite(pfp), Unwrite(name), Unwrite(hi), lag_ratio=0.5),
#         )
#
#         pass
