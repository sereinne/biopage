...
function Contacts() {
  return (
    <div class="contacts flex lg:flex-row flex-col  gap-x-2">
      <Contact
    ...
    <main class="portfolio bg-sleek-gray h-screen flex flex-col">
      <div class="introduction flex flex-col justify-center items-center my-auto">
        <div class="introduction-heading flex flex-col items-center gap-y-5">
          ...
          <p
            ref={ref}
            class="text-sleek-red lg:text-7xl text-xl font-bold font-sleek text-center"
          >
          </p>
          <Contacts />
        </div>
...
function ReworkFeature() {
  return (
    <div class="features h-screen bg-sleek-gray lg:border-t-5 lg:border-dashed lg:border-sleek-red border-t-2 border-dashed border-sleek-red">
      <div class="wrapper-repo-contrib flex lg:flex-row flex-col lg:gap-y-0 gap-y-5  justify-around mt-5">
        <div class="repositories flex flex-col gap-y-5">
          <div class="repo-header-wrapper flex justify-center items-center gap-x-3">
            <p class="font-sleek text-sleek-gray bg-sleek-red font-semibold lg:text-5xl text-3xl px-2 pt-1 pb-2 rounded-lg">
              Repositories
            </p>
            <img
              src="/assets/repo.svg"
              class="lg:size-14 size-12 bg-sleek-red px-2 py-1 rounded-lg"
            />
          </div>
          <div class="repo-list flex flex-col gap-y-5 lg:mx-0 mx-3">
            <RepoBtn
              repoName="gummypy"
        ...
        <div class="contributions flex flex-col gap-y-5">
          ...
          <div class="contrib-list flex flex-col gap-y-5 lg:mx-0 mx-3">
            <ContribBtn
...
function Ending() {
  return (
    <div class="ending bg-sleek-red py-2 px-1">
      <p class="copyright lg:text-lg text-sm font-sleek text-sleek-gray text-center">
